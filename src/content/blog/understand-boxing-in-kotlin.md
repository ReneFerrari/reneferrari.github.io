...
description: "What it is, when it happens and how to deal with it."
date: 2019-06-15
tags: ["Kotlin", "Performance", "Android"]
readTime: "4 min read"
---

## Introduction
Boxing describes the process of converting a primitive value to an object and unboxing therefore the inverse: object to primitive. Autoboxing refers to the process in which the compiler will handle this automatically for you. Whilst this is very handy it unfortunately leads to a decrease in performance. An example of autoboxing would be the following:
...
Both of these lines do the exact same thing internally. In the first line the primitive int value 42 is autoboxed and in the second line I manually box it.

Note: This article only covers Kotlin being run on the JVM.
